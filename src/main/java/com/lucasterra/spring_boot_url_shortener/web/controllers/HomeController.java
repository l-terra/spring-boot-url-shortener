...
public class HomeController {
    ...
    private void addShortUrlsDataToModel(Model model, int pageNumber) {
        PagedResult<ShortUrlDto> shortUrls = shortUrlService.findAllPublicShortUrls(pageNumber, properties.pageSize());
